        ...
        <section className="relative bg-[#1F3325] py-24 px-6 text-[#F5EFE6]">
            ...
            >
              ...
              {t.contactSection?.directionsBtn || 'Kreni do nas'}
                        ...
                        <a
                            href="https://www.google.com/maps/dir//Провалије+28+Ledinci"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group relative mt-10 inline-flex items-center justify-center gap-3 overflow-hidden rounded-full bg-[#C19A5B] px-8 py-4 text-base font-bold text-[#1F3325] shadow-xl shadow-[#C19A5B]/20 transition-all duration-300 hover:-translate-y-1 hover:bg-[#d3ac6c] hover:shadow-[#C19A5B]/40 active:scale-95"
                        >
                            {/* Efekat odsjaja (Shine) koji prelazi preko dugmeta na hover */}
                            <div className="absolute inset-0 -translate-x-full bg-white/30 transition-transform duration-500 ease-in-out group-hover:translate-x-full" />

                            <Navigation
                                size={20}
                                className="relative z-10 transition-transform duration-300 group-hover:translate-x-1 group-hover:-translate-y-1 group-hover:rotate-12"
                            />
