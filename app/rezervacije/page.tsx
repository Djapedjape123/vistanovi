...
export const metadata: Metadata = {
  ...
  keywords: ['rezervacija vikendice', 'cena vikendice na dan', 'iznajmljivanje vikendice Novi Sad', 'provera raspoloživosti', 'smeštaj Fruška gora'],
  alternates: {
    canonical: 'https://vistanovi.vercel.app/rezervacije', // Zameniti pravim domenom kasnije
  },
  openGraph: {
    ...
    url: 'https://vistanovi.vercel.app/rezervacije', // Zameniti pravim domenom kasnije
  }
};
